    ...
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[9999] h-[3px]">
      <div className="relative h-full w-full overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 blur-sm opacity-70">
          <div
            className="h-full w-full bg-gradient-to-r from-emerald-400 via-teal-300 to-lime-300"
        ...
        {/* Thanh chính */}
        <div
          className="relative h-full rounded-full bg-gradient-to-r from-emerald-400 via-teal-300 to-lime-300 shadow-[0_0_12px_rgba(0,0,0,0.35)]"
          style={{
            width: `${progress}%`,
